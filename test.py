            ...
            for idx in range(0, self.dataset_size, self.batch_size):
                ...
                for i in range(len(batch_sml)):
                    ...
                    interpolated = np.array(
                        imresize(batch_sml[i], size=(self.odims[0], self.odims[1]), interp=args.interpol),
                        dtype=np.uint8)
                ...
                print('Average SSIM for bicubic: {0:.4f}, Average SSIM for SRGAN: {1:.4f}'.format(avg_1 / total,
                                                                                                  avg_2 / total))
